...
namespace mvcmultireg
{
    ...
    public partial class mvcmultiuserregEntities : DbContext
    {
        public mvcmultiuserregEntities()
            : base("name=mvcmultiuserregEntities")
        {
        }
        ...
        public virtual int sp_userReg(Nullable<int> aid, string ana, string aaddr, string phone, string aemail)
        {
